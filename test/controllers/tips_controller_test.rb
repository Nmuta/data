...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { frequency: @tip.frequency, icon_id: @tip.icon_id, tip: @tip.tip, user_id: @tip.user_id }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { frequency: @tip.frequency, icon_id: @tip.icon_id, tip: @tip.tip, user_id: @tip.user_id }
    assert_redirected_to tip_path(assigns(:tip))
  end
